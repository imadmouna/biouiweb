...
if(isset($_REQUEST["dec"]) and $_REQUEST["dec"]=="1"){
  ...
  if(isset($_GET['texte']) and $_GET['texte']){
      mysql_query("update candidat set texte='".addslashes(utf8_encode($_GET['texte']))."'");
      echo "<script>document.location.href='candidat.php';</script>";
  }
?>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small>Candidatures spontan&eacute;es</small>
          </h1>
          <ol class="breadcrumb">
