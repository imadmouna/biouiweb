...
?>
          <tr>
            ...
            <td>
              <img src="../images/uploads/reference/small/<?php echo $ttq[1];?>" width="50" class="img-thumbnail" />
              <?php echo $ttq[1];?></td>
            ...
            <td>
              <div class="pull-right col-md-5">
                <div class="col-md-6">
                  ...
                  href="../images/uploads/reference/small/<?php echo $ttq[1];?>" class="btn btn-success btn-xs">
