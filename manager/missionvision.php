...
if(isset($_REQUEST["dec"]) and $_REQUEST["dec"]=="1"){
  ...
  if(isset($_GET['texte']) and $_GET['texte']){
      mysql_query("update missionvision set texte='".addslashes(utf8_encode($_GET['texte']))."'");
      echo "<script>document.location.href='missionvision.php';</script>";
  }
?>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small>Texte mission et vission</small>
          </h1>
          <ol class="breadcrumb">
