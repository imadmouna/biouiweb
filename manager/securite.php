...
if(isset($_REQUEST["dec"]) and $_REQUEST["dec"]=="1"){
  ...
  if(isset($_GET['texte']) and $_GET['texte']){
      mysql_query("update securite set texte='".addslashes(utf8_encode($_GET['texte']))."'");
      echo "<script>document.location.href='securite.php';</script>";
  }
?>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small>Texte securit&eacute;</small>
          </h1>
          <ol class="breadcrumb">
