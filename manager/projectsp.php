...
if(isset($_REQUEST["dec"]) and $_REQUEST["dec"]=="1"){
  ...
  if(isset($_GET['spr']) and $_GET['spr']){
      mysql_query("delete from uploadTextProjetSp where chemin like '%".$_GET['spr']."%'");
      unlink("../images/uploads/projetsp/small/".$_GET['spr']);
      unlink("../images/uploads/projetsp/big/".$_GET['spr']);
      echo "<script>document.location.href='projectsp.php';</script>";
  }
?>
