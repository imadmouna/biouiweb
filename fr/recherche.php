...
<title>Recherche - BIOUITRAVAUX</title>
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="60" align="left" valign="middle" background="img/bg_t.jpg" style="padding-left:10px;padding-top:0px;font-size:26px;color:#77AD1B;">R&eacute;sultats de recherche pour &quot; <?php 
  ...
  <tr>
	...
	<?php
		if(isset($_REQUEST['recherche']) and $_REQUEST['recherche']){
			...
			$req1=mysql_query("select * from data_link1 where contenu like '%$mc%'");
			$t=mysql_fetch_array($req1);
			if(empty($t))echo "Aucun résultat trouvé, veuillez vérifier votre critère de recherche!";
			$req=mysql_query("select * from data_link1 where contenu like '%$mc%'");
