<?php
	...
	$map->setAPIKey('ABQIAAAAShTzG8kE5LrshiwnXaFtxRQgbrIIaA7iMx5e1jON1O3bm-exOxS7qpqzj5ja2hjkzliXYJ1mJIccXA');
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="60" align="left" valign="middle" background="img/bg_t.jpg" style="padding-left:10px;padding-top:0px;font-size:26px;color:#77AD1B;">References</td>
  </tr>
  <tr>
    <td align="left" valign="top" style="padding-left:40px;padding-right:40px;color:#666666"><p>
      <br />
More than 200 projects and works have been performed by Biouitravaux  for several administration since 2000. <br />
<br />
<br />
Among recent achievements, we can cite the following: <br />
<br />
	...
	<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;sensor=true&amp;key=ABQIAAAAShTzG8kE5LrshiwnXaFtxRQgbrIIaA7iMx5e1jON1O3bm-exOxS7qpqzj5ja2hjkzliXYJ1mJIccXA" type="text/javascript"></script>
