...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left" valign="middle" height="60" style="padding-left:10px;padding-top:10px;font-size:26px;color:#77AD1B;">Hydraulic works &amp; Civil Engineering<br />
      <br /></td>
  </tr>
  <tr>
    <td align="left" valign="top" style="padding-left:10px;padding-right:20px;color:#666666"><br />
			...
			Hydraulic works are made with awareness, what materials are used, how works are done, and the techniques engineers use to make the final results resistant to hurricanes, earthquakes, fires, and other forces of nature.<br />
			    ...
			    a <b>quality</b> know-how combined with <b>efficiency</b> in order to achieve its goal in all construction segments in <b>Morocco</b>.
			    <p>Here is some of our projects in Building Construction &amp; Civil Engineering segment:</p>
			</div><br /><br />
	
	<div class="demo" style="width:920px;font-size:12px;padding-left:20px">
  <div id="accordion">
  <h3 style="background-image:url(img/imgg.png); background-repeat:repeat-y;background-position:left"><a href="#" style="color:#666666">Ongoing Projects</a></h3>
  ...
  <h3 style="background-image:url(img/imgg.png); background-repeat:repeat-y;background-position:left"><a href="#" style="color:#666666">Completed Projects</a></h3>
...
</tr></table><div style='border-bottom:1px #cccccc dotted'>&nbsp;</div><br />
...
<br /><b>Development</b> of the cornice of Saidia Lot # 1 Big-works Coatings (2nd slice)
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  </td></tr></table><div style='border-bottom:1px #cccccc dotted'>&nbsp;</div><br />
			  <br />
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="100" height="100" align="left" valign="middle"><img src="img/logo/fadesa.jpg" width="89" height="25" /></td>
			  ...
			  </td></tr></table><div style='border-bottom:1px #cccccc dotted'>&nbsp;</div></td>
        </tr>
      </table></div>
