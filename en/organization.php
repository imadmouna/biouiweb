...
<title>Organization - BIOUITRAVAUX</title>
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="60" align="left" valign="middle" background="img/bg_t.jpg" style="padding-left:10px;padding-top:0px;font-size:26px;color:#77AD1B">Organization </td>
  </tr>
  <tr>
    <td align="left" valign="top" style="padding-left:40px;color:#666666">
	<br />
	- President & CEO: Abdennabi BIIOUI<br />
	<br />

- General Manager: Abderrahim BIIOUI<br />
<br />

- Director of Finance and administrative:  Khalid SEDDAS<br />
<br />

- Managing and Technical Director: Onder CAY<br />
<br />

- Logistic and Machinery Director: Mohamed TABICH<br />
<br /><br /><br />

 

<div style="font-size:20px;font-weight:bold;color:#77AD1B">The organization of Biouitravaux and structured project revolves around four polesbackbone:</div>
<p><br />
    <br />
  
  
  Managing and Technical center that integrates all design activities, study engineering, managing production and projects, business development. </p>
<p> Financial and Administrative division, which encompasses the activities of financial control, computer and administrative monitoring
  
  Pole Material responsible for managing the machinery park, purchase and initiate preventive maintenance actions and corrective.<br />
  <br />
  Health Safety and Environment Center whose mission is to monitor the issues related to heath, safety and the environment.<br />
  <br />
...
<div align="center">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="middle">Our organization chart by project as following :</td>
          <td align="left" valign="middle"><img src="img/services.jpg" width="345" height="441" /></td>
        </tr>
      </table>
	  </div>
	</td>
