...
<title>Transportations &amp; Infrastructures - BIOUITRAVAUX</title>
...
<table width="1000" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="left" valign="middle" height="60" style="padding-left:10px;padding-top:10px;font-size:26px;color:#77AD1B;">Transportations &amp; Infrastructures<br />
      <br /></td>
  </tr>
  <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td align="left" valign="top" style="padding-left:0px"><br />
                              ...
                              <?php
                                $queryq = mysql_query("select * from projets where cat = 'projecttri' and type=1 order by titre");
                        ...
                        <tr>
                          <td align="left" valign="top" style="padding-left:20px"><br />
                            ...
                            <br />
                              ...
                              <?php
                                $queryq = mysql_query("select * from projets where cat = 'projecttri' and type=2 order by titre");
                                while($tqq = mysql_fetch_array($queryq)){
                              ?>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
