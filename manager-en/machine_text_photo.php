...
if(isset($_REQUEST["dec"]) and $_REQUEST["dec"]=="1"){
  ...
  if(isset($_GET['texte']) and $_GET['texte']){
      mysql_query("update texte_parc set texte='".addslashes(utf8_encode($_GET['texte']))."'");
      echo "<script>document.location.href='machine_text_photo.php';</script>";
  }
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small>Parcs de machines - texte et photos</small>
          </h1>
